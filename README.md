...
- Cliquer sur « Choose image » ou « Choose another image » selon l’écran, pour sélectionner une photo de test.
- Rognage
  ...
  - Auto crop :
    ...
    - Redimensionner la zone de marquages si elle n’est pas correcte.
...
- Effectuer une ou plusieurs analyses avec des images de test ([Utilisation](#Utilisation)) pour télécharger tous les fichiers de l’application et les stocker sur l'appareil mobile.
